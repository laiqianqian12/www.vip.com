...
* @Last Modified time: 2018-12-13 15:12:10
*/
...
* @Date:   2018-12-13 13:28:23
* @Last Modified by:   anchen
* @Last Modified time: 2018-12-13 13:36:39
*/
// 秒杀成功的商品列表
// 护肤
$.ajax({
       ...
       str+=`<li><img src="${item.imgurl}" alt=""><a href="successDetail.html">${item.content}
...
var miaoshaLis=document.getElementById('miaoshaList_jiayong')
    ...
    for(var i=0;i<data.length;i++){
        str+=`<li><img src="${data[i].imgurl}" alt=""><a href="successDetail.html">${data[i].content}
